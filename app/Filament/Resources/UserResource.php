...
class UserResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'user'; //for change resource name in the sidebar

    protected static ?string $modelLabel = 'user'; //for change the title of the page and button

    protected static ?string $slug = 'user'; //for changing the url
