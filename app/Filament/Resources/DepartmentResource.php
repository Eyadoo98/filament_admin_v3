...
class DepartmentResource extends Resource
{
    ...
    protected static ?string $navigationIcon = 'heroicon-o-academic-cap'; //for change icon in the sidebar

    protected static ?string $navigationLabel = 'department'; //for change resource name in the sidebar
...
//CountryResource::$navigationLabel = 'country';
    ...
    protected static ?string $modelLabel = 'department'; //for change the title of the page and button

    protected static ?string $slug = 'department'; //for changing the url
        ...
        return $table
            ->columns([
                Tables\Columns\TextColumn::make('name')
                    ->searchable(),
                Tables\Columns\TextColumn::make('employees_count')->counts('employees')//for count the employees in the department
                    ->searchable()
                    ->sortable(),
